...
class Train1Week(QWidget):
    def __init__(self):
        super().__init__()

        self.defaults_params_dicts = {
            'domestic_transformerv1_avgsel_1week':{
                'param_split_pct':"20",
                'param_seed':"0",
                'param_window':"168",
                'param_n_units':"--------",
    ...
    def sendConfig(self):
        parser = ConfigParser()
        parser.read('src/deep_learning_1week/model_config.ini')
    ...
    def sendInferenceCConfig(self):
        ...
        infer_parser.read('src/deep_learning_1week/infer_model_config.ini')
