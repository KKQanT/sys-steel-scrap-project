...
if __name__ == "__main__":
    ...
    df_train.to_csv('../../output/domestic_baseline_gru_avg.csv', index=False)
    df_val.to_csv('../../output/domestic_baseline_gru_avg.csv', index=False)
    df_test.to_csv('../../output/domestic_baseline_gru_avg', index=False)
