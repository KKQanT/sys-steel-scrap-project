...
if __name__ == "__main__":
    ...
    SAVE_PATH = '../../data/preprocessed/domestic_transformerv1_avgsel_week1_to_12.csv'
    MAX_WINDOW = 7*4*6
    ...
    df_main['target'] = df_main.apply(lambda x : [x[f'target_{i}'] for i in range(1, 13)], axis=1)
